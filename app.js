$(document).ready(function() {
    ...
    coleccionProductos.on("child_added", datos => {        
        dataSet = [datos.key,datos.child("linea").val(), datos.child("codigo").val(), datos.child("descripcion").val(), datos.child("cantidad").val()];
    ...
    $('form').submit(function(e){                         
        ...
        data = {linea:linea, codigo:codigo, descripcion: descripcion, cantidad: cantidad};             
        actualizacionData = {};
